...
def passfail(tend):
    if tend == 'pass':
        htl = '''<td width=50 bgcolor="green">pass</td>'''
    elif tend == 'fail':
        htl = '''<td width=50 bgcolor="fail">fail</td>'''
    elif tend == 'weizhi':
        htl = '''<td width=50 bgcolor="red">error</td>'''
    else:
        htl = '<td width=50 bgcolor="crimson">exect</td>'
    return htl
